...
import specialistsData from '@/data/usa-visa-j1-specialists.json'

export default function SpecialistsPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? specialistsData.ar : specialistsData.en
          ...
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              <div className="text-center">
                <div className="display-4 fw-bold text-white">2W-2Y</div>
                <div className="text-white-50">
                  {isRTL ? "أسابيع-سنوات" : "Weeks-Years"}
                </div>
              </div>
              <div className="text-center">
                <div className="display-4 fw-bold text-white">Expert</div>
                <div className="text-white-50">
                  {isRTL ? "خبرة" : "Exchange"}
                </div>
              </div>
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'star' : i === 1 ? 'briefcase' : i === 2 ? 'envelope' : i === 3 ? 'language' : i === 4 ? 'trophy' : 'handshake'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'share' : i === 1 ? 'lightbulb' : i === 2 ? 'network-wired' : i === 3 ? 'user-graduate' : i === 4 ? 'globe' : i === 5 ? 'chart-line' : 'atom'} text-primary`}></i>
                      </div>
                      <div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة تبادل الخبرة اليوم" : "Start Your Expertise Exchange Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج المتخصصون مع خبرائنا" :
               "Get help applying for the Specialists program with our experts"}
            </p>
