...
import auPairData from '@/data/usa-visa-j1-au-pair.json'

export default function AuPairPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? auPairData.ar : auPairData.en
  ...
  return (
    <>
          ...
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              <div className="text-center">
                <div className="display-4 fw-bold text-white">12</div>
                <div className="text-white-50">
                  {isRTL ? "أشهر" : "Months"}
                </div>
              </div>
              <div className="text-center">
                <div className="display-4 fw-bold text-white">30-45</div>
                <div className="text-white-50">
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'calendar' : i === 1 ? 'graduation-cap' : i === 2 ? 'child' : i === 3 ? 'language' : i === 4 ? 'id-card' : i === 5 ? 'search' : 'ban'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'child' : i === 1 ? 'broom' : i === 2 ? 'car' : i === 3 ? 'book' : i === 4 ? 'shield-alt' : i === 5 ? 'comments' : 'users'} text-success`}></i>
                      </div>
                      <div>
              ...
              <div className="col-md-6 col-lg-4" key={i}>
                <div className="card h-100">
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'home' : i === 1 ? 'graduation-cap' : i === 2 ? 'language' : i === 3 ? 'heart' : i === 4 ? 'handshake' : i === 5 ? 'dollar-sign' : 'briefcase'} text-primary`}></i>
                      </div>
                      <div>
      ...
      <section className="section bg-light">
        <div className="container">
          <h2 className="section-title text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.host_family_matching.heading}
          </h2>
          <p className="section-subtitle text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.host_family_matching.description}
          </p>

          <div className="row g-4 mt-5 justify-content-center">
            {data.host_family_matching.considerations.map((consideration, i) => (
              <div className="col-md-6 col-lg-4" key={i}>
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'map-marker-alt' : i === 1 ? 'users' : i === 2 ? 'gem' : i === 3 ? 'building' : 'car'} fs-2 text-info`}></i>
                    </div>
                    <p className="card-text small">{consideration}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section">
        <div className="container">
          <h2 className="section-title text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.education_training.heading}
          </h2>
          <p className="section-subtitle text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.education_training.description}
          </p>

          <div className="row g-4 mt-5 justify-content-center">
            {data.education_training.components.map((component, i) => (
              <div className="col-md-6 col-lg-4" key={i}>
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'laptop' : i === 1 ? 'user-friends' : i === 2 ? 'chart-line' : i === 3 ? 'university' : i === 4 ? 'medkit' : 'baby'} fs-2 text-success`}></i>
                    </div>
                    <p className="card-text small">{component}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section bg-light">
        <div className="container">
          <h2 className="section-title text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.program_sponsors.heading}
          </h2>

          <div className="row g-4 mt-5 justify-content-center">
            {data.program_sponsors.sponsors.map((sponsor, i) => (
              <div className="col-md-6 col-lg-4" key={i}>
                <div className="card h-100">
                  <div className="card-body">
                    <h5 className="card-title text-center mb-3">{sponsor.name}</h5>
                    <p className="card-text small text-center">{sponsor.description}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section bg-light">
        <div className="container">
          <h2 className="section-title text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.challenges_solutions.heading}
          </h2>

          <div className="row g-4 mt-5 justify-content-center">
            {data.challenges_solutions.items.map((item, i) => (
                ...
                <div className="card h-100">
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      ...
                      <p className="mb-0 small">{item.solution}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة المساعد المنزلي اليوم" : "Start Your Au Pair Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج المساعدين المنزليين مع خبرائنا" :
               "Get help applying for the Au Pair program with our experts"}
            </p>
