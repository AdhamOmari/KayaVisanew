...
import teachersData from '@/data/usa-visa-j1-teachers.json'

export default function TeachersPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? teachersData.ar : teachersData.en
        ...
        <div className="container">
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              ...
              <div className="text-center">
                <div className="display-4 fw-bold text-white">Educational</div>
                <div className="text-white-50">
                  {isRTL ? "تعليمي" : "Exchange"}
                </div>
              </div>
              <div className="text-center">
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'graduation-cap' : i === 1 ? 'chalkboard-teacher' : i === 2 ? 'envelope' : i === 3 ? 'language' : i === 4 ? 'star' : 'calendar'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'school' : i === 1 ? 'user-graduate' : i === 2 ? 'users' : i === 3 ? 'heart' : i === 4 ? 'eye' : i === 5 ? 'book' : 'globe'} text-primary`}></i>
                      </div>
                      <div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة التبادل التعليمي اليوم" : "Start Your Educational Exchange Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج المعلمون مع خبرائنا" :
               "Get help applying for the Teachers program with our experts"}
            </p>
