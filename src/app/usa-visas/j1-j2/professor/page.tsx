...
import professorData from '@/data/usa-visa-j1-professor.json'

export default function ProfessorPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? professorData.ar : professorData.en
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'graduation-cap' : i === 1 ? 'chalkboard-teacher' : i === 2 ? 'envelope' : i === 3 ? 'language' : i === 4 ? 'book' : 'calendar'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'university' : i === 1 ? 'microscope' : i === 2 ? 'network-wired' : i === 3 ? 'lightbulb' : i === 4 ? 'users' : i === 5 ? 'handshake' : 'star'} text-primary`}></i>
                      </div>
                      <div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة التبادل الأكاديمي اليوم" : "Start Your Academic Exchange Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج الأستاذ الجامعي مع خبرائنا" :
               "Get help applying for the University Professor program with our experts"}
            </p>
