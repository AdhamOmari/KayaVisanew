...
import shortTermScholarsData from '@/data/usa-visa-j1-short-term-scholars.json'

export default function ShortTermScholarsPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? shortTermScholarsData.ar : shortTermScholarsData.en
          ...
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              <div className="text-center">
                <div className="display-4 fw-bold text-white">1-6</div>
                <div className="text-white-50">
                  {isRTL ? "أشهر" : "Months"}
                </div>
              </div>
              <div className="text-center">
                <div className="display-4 fw-bold text-white">Short-term</div>
                <div className="text-white-50">
                  {isRTL ? "قصير" : "Academic"}
                </div>
              </div>
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'graduation-cap' : i === 1 ? 'envelope' : i === 2 ? 'language' : i === 3 ? 'star' : i === 4 ? 'handshake' : 'passport'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'network-wired' : i === 1 ? 'exchange-alt' : i === 2 ? 'school' : i === 3 ? 'user-graduate' : i === 4 ? 'heart' : i === 5 ? 'handshake' : 'trophy'} text-primary`}></i>
                      </div>
                      <div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة التبادل الأكاديمي القصير اليوم" : "Start Your Short-term Academic Exchange Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج الباحثون لفترة قصيرة مع خبرائنا" :
               "Get help applying for the Short-term Scholars program with our experts"}
            </p>
