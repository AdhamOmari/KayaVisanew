...
import secondaryStudentData from '@/data/usa-visa-j1-secondary-student.json'

export default function SecondaryStudentPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? secondaryStudentData.ar : secondaryStudentData.en
  ...
  return (
    <>
      ...
      <section className="hero-section" style={{
        backgroundImage: 'url(https://images.unsplash.com/photo-1509062522246-3755977927d7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)',
          ...
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              <div className="text-center">
                <div className="display-4 fw-bold text-white">1</div>
                <div className="text-white-50">
                  {isRTL ? "عام دراسي" : "Academic Year"}
                </div>
              </div>
              <div className="text-center">
                <div className="display-4 fw-bold text-white">High School</div>
                <div className="text-white-50">
                  {isRTL ? "تبادل" : "Exchange"}
                </div>
              </div>
              <div className="text-center">
            ...
            <div className="d-flex justify-content-center gap-3 mt-5 flex-wrap">
              <a href="#host-family" className="btn btn-primary">
                {isRTL ? "العائلة المضيفة" : "Host Family"}
              </a>
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'birthday-cake' : i === 1 ? 'school' : i === 2 ? 'award' : i === 3 ? 'language' : i === 4 ? 'shield-alt' : i === 5 ? 'calendar-check' : 'user-check'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'globe' : i === 1 ? 'language' : i === 2 ? 'user' : i === 3 ? 'users' : i === 4 ? 'running' : i === 5 ? 'university' : 'star'} text-primary`}></i>
                      </div>
                      <div>
      ...
      <section id="host-family" className="section">
        <div className="container">
          <h2 className="section-title text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.host_family_experience.heading}
          </h2>
          <p className="section-subtitle text-center" dir={isRTL ? "rtl" : "ltr"}>
            {data.host_family_experience.description}
          </p>

          <div className="row g-4 mt-5 justify-content-center">
            {data.host_family_experience.aspects.map((aspect: any, i: number) => (
              <div className="col-md-6 col-lg-3" key={i}>
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'heart' : i === 1 ? 'comments' : i === 2 ? 'hands-helping' : 'home'} fs-2 text-success`}></i>
                    </div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة التبادل الثانوي اليوم" : "Start Your High School Exchange Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج التبادل الثانوي مع خبرائنا" :
               "Get help applying for the Secondary Student Exchange program with our experts"}
            </p>
