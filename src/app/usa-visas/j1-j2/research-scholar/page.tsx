...
import researchScholarData from '@/data/usa-visa-j1-research-scholar.json'

export default function ResearchScholarPage() {
  const { locale } = useI18n()
  const data = (researchScholarData as any).en
        ...
        <div className="container">
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              ...
              <div className="text-center">
                <div className="display-4 fw-bold text-white">Research</div>
                <div className="text-white-50">
                  {isRTL ? "بحث" : "Scholar"}
                </div>
              </div>
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'graduation-cap' : i === 1 ? 'file-alt' : i === 2 ? 'envelope' : i === 3 ? 'language' : i === 4 ? 'book' : 'calendar'} fs-2 text-primary`}></i>
                    </div>
            ...
            {data.research_areas.categories.map((category: any, i: number) => (
              <div className="col-md-6 col-lg-3" key={i}>
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'microscope' : i === 1 ? 'users' : i === 2 ? 'book' : 'dna'} fs-2 text-success`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'flask' : i === 1 ? 'users' : i === 2 ? 'network-wired' : i === 3 ? 'newspaper' : i === 4 ? 'lightbulb' : i === 5 ? 'handshake' : 'trophy'} text-primary`}></i>
                      </div>
                      <div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة البحث الأكاديمي اليوم" : "Start Your Research Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج عالم البحث مع خبرائنا" :
               "Get help applying for the Research Scholar program with our experts"}
            </p>
