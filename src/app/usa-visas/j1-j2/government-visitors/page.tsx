...
import governmentVisitorsData from '@/data/usa-visa-j1-government-visitors.json'

export default function GovernmentVisitorsPage() {
  const { locale } = useI18n()
  const data = locale === 'ar' ? governmentVisitorsData.ar : governmentVisitorsData.en
  ...
  return (
    <>
      ...
      <section className="hero-section" style={{
        backgroundImage: 'url(https://images.unsplash.com/photo-1529107386315-e1a2ed48a620?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)',
        ...
        <div className="container">
          <div className="hero-content text-center" dir={isRTL ? "rtl" : "ltr"}>
            ...
            <div className="d-flex justify-content-center gap-4 mt-5 flex-wrap">
              ...
              <div className="text-center">
                <div className="display-4 fw-bold text-white">Diplomatic</div>
                <div className="text-white-50">
                  {isRTL ? "دبلوماسي" : "Exchange"}
                </div>
              </div>
              <div className="text-center">
            ...
            <div className="d-flex justify-content-center gap-3 mt-5 flex-wrap">
              ...
              <a href="#application" className="btn btn-secondary">
                {isRTL ? "عملية التقديم" : "Application"}
              </a>
            </div>
          </div>
        </div>
                ...
                <div className="card h-100">
                  <div className="card-body text-center">
                    <div className="feature-icon mb-3">
                      <i className={`fas fa-${i === 0 ? 'landmark' : i === 1 ? 'briefcase' : i === 2 ? 'language' : i === 3 ? 'shield-alt' : i === 4 ? 'crown' : 'share'} fs-2 text-primary`}></i>
                    </div>
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-start gap-3">
                      <div className="feature-icon">
                        <i className={`fas fa-${i === 0 ? 'handshake' : i === 1 ? 'building' : i === 2 ? 'globe' : i === 3 ? 'user-graduate' : i === 4 ? 'users' : i === 5 ? 'book' : 'star'} text-primary`}></i>
                      </div>
                      <div>
        ...
        <div className="container">
          <div className="text-center" dir={isRTL ? "rtl" : "ltr"}>
            <h2 className="section-title text-white">
              {isRTL ? "ابدأ رحلة التبادل الدبلوماسي اليوم" : "Start Your Diplomatic Exchange Journey Today"}
            </h2>
            <p className="section-subtitle text-white-50">
              {isRTL ? "احصل على المساعدة للتقديم لبرنامج الزائرون الحكوميون مع خبرائنا" :
               "Get help applying for the Government Visitors program with our experts"}
            </p>
