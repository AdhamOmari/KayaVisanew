'use client'
import "@/styles/st-kitts-nevis.css"
  ...
  return (
    <div className="dominica-page">
            ...
            <div className="col-lg-8 mx-auto">
              <div className="modern-card" dir={isRTL ? "rtl" : "ltr"}>
                <h2 className="text-center mb-4">
                  {isRTL ? "لماذا جنسية سانت كيتس ونيفيس؟" : "Why St. Kitts & Nevis Citizenship?"}
                </h2>
                ...
                <div className="country-info-grid">
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      ...
                      <p>{isRTL ? "جزر ليوارد شرق الكاريبي" : "Leeward Islands, Eastern Caribbean"}</p>
                    </div>
                  </div>
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      ...
                      <p>{isRTL ? "25 عالمياً" : "25th worldwide"}</p>
                    </div>
                  </div>
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      ...
                      <p>{isRTL ? "ملكية دستورية فدرالية" : "Federal constitutional monarchy"}</p>
                    </div>
                  </div>
                  ...
                  <div className="info-item">
                    ...
                    <div className="info-content">
                      <h5>{isRTL ? "التميز" : "Excellence"}</h5>
                      <p>{isRTL ? "أقدم برنامج جنسية استثمارية (1984)" : "Oldest citizenship by investment program (1984)"}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row g-4 mt-5">
            <div className="col-md-4">
              <div className="modern-card text-center">
                ...
                <h3>{isRTL ? "برنامج مرموق" : "Prestigious Program"}</h3>
                <p>
                  {isRTL ? "من أشهر برامج الجنسية الاستثمارية في العالم منذ 1984" : 
                   "One of the world's most renowned citizenship programs since 1984"}
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="modern-card text-center">
                ...
                <h3>{isRTL ? "حرية السفر" : "Travel Freedom"}</h3>
                <p>
                  {isRTL ? "الوصول إلى أكثر من 156 دولة بما في ذلك منطقة شنغن وبريطانيا" : 
                   "Access to 156+ countries including Schengen and UK"}
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="modern-card text-center">
                ...
                <h3>{isRTL ? "إدراج العائلة" : "Family Inclusion"}</h3>
                <p>
                  {isRTL ? "يشمل الزوج والأبناء والوالدين والأجداد" : 
                  ...
                  <div className="d-flex align-items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-light mb-0 small opacity-75">
                        {isRTL ? "ميزة حصرية في برنامج سانت كيتس ونيفيس" : 
                         "Exclusive benefit of St. Kitts & Nevis program"}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {data.qualification_options.options.map((opt, i) => (
              <div className="col-md-4" key={i}>
                <div className="modern-card text-center">
                  ...
                  <div className="mt-4">
                    <div className="text-gold fw-bold display-6 mb-2">$250,000+</div>
                  ...
                  <div className="col-md-6">
                    <div className="investment-detail">
                      ...
                      <div className="detail-content">
                        ...
                        <p>
                          {isRTL ? "ابتداءً من 250,000 دولار أمريكي." : 
                           "Starting from $250,000 USD."}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="investment-detail">
                      ...
                      <div className="detail-content">
                        ...
                        <p>
                          {isRTL ? "أقدم وأقوى برنامج جنسية في الكاريبي." : 
                           "Oldest and most powerful citizenship program in the Caribbean."}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="additional-options">
                      ...
                      <div className="options-grid">
                        <div className="option-item">
                          ...
                          <span>{isRTL ? "مساهمة لصندوق التنمية المستدامة" : "Contribution to Sustainable Growth Fund"}</span>
                        </div>
                        <div className="option-item">
            ...
            <div className="alert alert-gold bg-gradient-gold bg-opacity-10 border border-gold border-opacity-25 rounded-3 d-inline-flex align-items-center gap-3 px-4 py-3">
              ...
              <div className="text-start">
                ...
                <p className="mb-0 text-dark">
                  {isRTL ? "عادة ما تستغرق العملية من 6 إلى 9 أشهر بعد تقديم الطلب واستكمال جميع المستندات والفحوصات الأمنية. في بعض الحالات السريعة يمكن أن يتم الإنجاز خلال 4 إلى 6 أشهر فقط." : 
                   "Typically takes 6 to 9 months after submitting the application and completing all documents and security checks. In some fast-track cases, completion can be achieved within 4 to 6 months only."}
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="visa-free" className="section-modern">
        <div className="container">
          <h2 className="section-title" dir={isRTL ? "rtl" : "ltr"}>
            {isRTL ? "حرية التنقل بجواز سانت كيتس ونيفيس" : "Travel Freedom with St. Kitts & Nevis Passport"}
          </h2>
          
          <div className="visa-categories">
            <div className="visa-category visa-free">
              <div className="category-header">
                <h3>{isRTL ? "بدون تأشيرة (حوالي 124 دولة)" : "Visa-Free (Approx. 124 countries)"}</h3>
      ...
      <section className="modern-cta">
        <div className="cta-content" dir={isRTL ? "rtl" : "ltr"}>
          <h2 className="cta-title">
            {isRTL ? "احصل على جنسية سانت كيتس ونيفيس الآن" : "Get St. Kitts & Nevis Citizenship Now"}
          </h2>
          <p className="cta-subtitle">
            {isRTL ? "انضم إلى آلاف العائلات التي حصلت على جواز سفر سانت كيتس ونيفيس. احجز استشارتك المجانية اليوم." : 
             "Join thousands of families who have obtained St. Kitts & Nevis passport. Book your free consultation today."}
          </p>
