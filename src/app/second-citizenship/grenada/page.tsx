...
export default function GrenadaPage() {
  ...
  const data = locale === 'ar' ? grenadaData.ar : grenadaData.en
          ...
          <div className="row g-4 mt-5">
            <div className="col-md-4">
              <div className="modern-card text-center">
                ...
                <h3>{isRTL ? "جزيرة التوابل" : "Spice Island"}</h3>
                <p>
                  {isRTL ? "مشهورة عالمياً بإنتاج التوابل والجمال الطبيعي" : 
                   "World-famous for spice production and natural beauty"}
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="modern-card text-center">
                ...
                <h3>{isRTL ? "الوصول إلى أمريكا" : "US E-2 Visa Access"}</h3>
                <p>
                  {isRTL ? "الدولة الوحيدة في الكاريبي المؤهلة لتأشيرة E-2 الأمريكية" : 
                   "Only Caribbean nation eligible for US E-2 Treaty Investor Visa"}
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="modern-card text-center">
                ...
                <h3>{isRTL ? "جنة استوائية" : "Tropical Paradise"}</h3>
                <p>
                  {isRTL ? "شواطئ خلابة ومناخ استوائي مثالي" : 
                   "Stunning beaches and perfect tropical climate"}
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="d-flex align-items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-light mb-0 small opacity-75">
                        {isRTL ? "ميزة حصرية في برنامج غرينادا" : 
                         "Exclusive benefit of Grenada program"}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {data.qualification_options.options.map((opt, i) => (
              <div className="col-md-4" key={i}>
                <div className="modern-card text-center">
                  ...
                  <div className="mt-4">
                    <div className="text-gold fw-bold display-6 mb-2">$150,000+</div>
      ...
      <section className="modern-cta">
        <div className="cta-content" dir={isRTL ? "rtl" : "ltr"}>
          ...
          <p className="cta-subtitle">
            {isRTL ? "انضم إلى آلاف العائلات التي حصلت على جواز سفر غرينادا. احجز استشارتك المجانية اليوم." : 
             "Join thousands of families who have obtained Grenada passport. Book your free consultation today."}
          </p>
