...
export default function PartnerDetailPage() {
  ...
  return (
    <div dir={dir} style={{ backgroundColor: '#fff', minHeight: '100vh' }}>
      {/* Hero Section */}
      <section
        style={{
          background: 'linear-gradient(135deg, #1c3269 0%, #2a4580 100%)',
          color: 'white',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flexWrap: 'wrap' }}>
                    <div
                      style={{
                        ...
                        height: '80px',
                        borderRadius: '12px',
                        background: 'linear-gradient(135deg, #1c3269 0%, #e2bc42 100%)',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    >
                      {partner.benefits.map((benefit: string, idx: number) => (
                        ...
                        >
                          ...
                          ></i>
                          <span style={{ color: '#1c3269' }}>{benefit}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
              ...
              >
                <div
                  style={{
                    ...
                    fontWeight: 'bold',
                    color: 'white',
                    boxShadow: '0 4px 15px rgba(28, 50, 105, 0.3)',
                  }}
                >
                  {step.number}
                </div>
          ...
          <Link href="/contact">
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 10px 25px rgba(226, 188, 66, 0.4)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
