...
import travelJapanDataImport from '@/data/travel-japan.json'

export default function TravelJapanPage() {
  const { locale } = useI18n()
  const travelJapanData: any = travelJapanDataImport
  const data = locale === 'ar' ? travelJapanData.ar : travelJapanData.en
