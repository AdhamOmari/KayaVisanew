...
import travelAustraliaDataImport from '@/data/travel-australia.json'

export default function TravelAustraliaPage() {
  const { locale } = useI18n()
  const travelAustraliaData: any = travelAustraliaDataImport
  const data = locale === 'ar' ? travelAustraliaData.ar : travelAustraliaData.en
