...
import travelUsaDataImport from '@/data/travel-usa.json'

export default function TravelUsaPage() {
  const { locale } = useI18n()
  const travelUsaData: any = travelUsaDataImport
  const data = locale === 'ar' ? travelUsaData.ar : travelUsaData.en
