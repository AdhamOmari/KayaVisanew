...
import travelCanadaDataImport from '@/data/travel-canada.json'

export default function TravelCanadaPage() {
  const { locale } = useI18n()
  const travelCanadaData: any = travelCanadaDataImport
  const data = locale === 'ar' ? travelCanadaData.ar : travelCanadaData.en
