...
import travelUaeDataImport from '@/data/travel-uae.json'

export default function TravelUaePage() {
  const { locale } = useI18n()
  const travelUaeData: any = travelUaeDataImport
  const data = locale === 'ar' ? travelUaeData.ar : travelUaeData.en
