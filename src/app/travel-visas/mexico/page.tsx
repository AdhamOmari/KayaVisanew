...
import travelMexicoDataImport from '@/data/travel-mexico.json'

export default function TravelMexicoPage() {
  const { locale } = useI18n()
  const travelMexicoData: any = travelMexicoDataImport
  const data = locale === 'ar' ? travelMexicoData.ar : travelMexicoData.en
