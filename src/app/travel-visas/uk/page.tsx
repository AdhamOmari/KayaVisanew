...
import travelUkDataImport from '@/data/travel-uk.json'

export default function TravelUkPage() {
  const { locale } = useI18n()
  const travelUkData: any = travelUkDataImport
  const data = locale === 'ar' ? travelUkData.ar : travelUkData.en
