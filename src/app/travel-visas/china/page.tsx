...
import travelChinaDataImport from '@/data/travel-china.json'

export default function TravelChinaPage() {
  const { locale } = useI18n()
  const travelChinaData: any = travelChinaDataImport
  const data = locale === 'ar' ? travelChinaData.ar : travelChinaData.en
