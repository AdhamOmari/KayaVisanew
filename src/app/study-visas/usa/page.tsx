        ...
        <div className="container">
          <div className="hero-content" dir={isRTL ? "rtl" : "ltr"}>
            <div className="hero-flag mb-4">
              <i className="fas fa-flag-usa fs-1"></i>
            </div>
      ...
      <section className="section-modern soft-bg">
        <div className="container">
          <h2 className="section-title" dir={isRTL ? "rtl" : "ltr"}>
            {data.why_america.heading}
          </h2>
          
          <div className="row g-4 mt-4">
            {data.why_america.reasons.map((reason: string, i: number) => (
      ...
      <section className="section-modern">
        <div className="container">
          ...
          <div className="row g-3 mt-4">
            {data.majors.list.map((major: string, i: number) => (
              <div className="col-md-6 col-lg-3" key={i}>
                <div className="badge-pill bg-study-primary text-white p-3 text-center" dir={isRTL ? "rtl" : "ltr"}>
                  {major}
                </div>
              </div>
            ))}
