  ...
  return (
    <>
        ...
        <div className="container">
          <div className="hero-content" dir={isRTL ? "rtl" : "ltr"}>
            <div className="hero-flag mb-4">
              <i className="fas fa-maple-leaf fs-1"></i>
            </div>
      ...
      <section className="section-modern soft-bg">
        <div className="container">
          <h2 className="section-title" dir={isRTL ? "rtl" : "ltr"}>
            {data.why_canada.heading}
          </h2>
          
          <div className="row g-4 mt-4">
            {data.why_canada.reasons.map((reason: string, i: number) => (
      ...
      <section className="section-modern">
        <div className="container">
          <h2 className="section-title" dir={isRTL ? "rtl" : "ltr"}>
            {data.financial_requirements.heading}
          </h2>
          
          <div className="row g-4 mt-5">
            <div className="col-lg-6">
              <div className="modern-card p-4 h-100" dir={isRTL ? "rtl" : "ltr"}>
                <p className="mb-4">{data.financial_requirements.description}</p>
                <ul className="list-unstyled">
                  {data.financial_requirements.requirements.map((req: string, i: number) => (
                    <li key={i} className="mb-2">
            ...
            <div className="col-lg-6">
              <div className="modern-card p-4 h-100" dir={isRTL ? "rtl" : "ltr"}>
                <h4 className="text-study-primary mb-3">{data.financial_requirements.deposit_info.title}</h4>
                <p className="mb-3">{data.financial_requirements.deposit_info.description}</p>
                <div className="alert alert-info" role="alert">
                  <i className="fas fa-info-circle me-2"></i>
                  {data.financial_requirements.deposit_info.note}
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section-modern soft-bg">
        <div className="container">
          ...
          <div className="row g-4 mt-4">
            ...
            <div className="col-lg-6">
              <div className="modern-card p-4 text-center" dir={isRTL ? "rtl" : "ltr"}>
                <i className="fas fa-hands-helping text-study-primary fs-1 mb-3"></i>
                <p className="mb-0">{data.student_life.support}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* APPLICATION STEPS */}
      <section id="application" className="section-modern soft-bg">
        <div className="container">
          <h2 className="section-title" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <section className="section-modern soft-bg">
        <div className="container">
          ...
          <div className="row g-4 mt-4">
            {data.tips.list.map((tip: string, i: number) => (
              <div className="col-md-6" key={i}>
                <div className="glass-card p-4" dir={isRTL ? "rtl" : "ltr"}>
                  <div className="d-flex align-items-start">
                    <i className="fas fa-star text-gold fs-3 me-3"></i>
                    <p className="text-white mb-0">{tip}</p>
                  </div>
                </div>
              </div>
            ))}
