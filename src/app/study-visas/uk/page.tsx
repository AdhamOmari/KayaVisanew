        ...
        <div className="container">
          <div className="hero-content" dir={isRTL ? "rtl" : "ltr"}>
            <div className="hero-flag mb-4">
              <i className="fas fa-crown fs-1"></i>
            </div>
      ...
      <section className="section-modern soft-bg">
        <div className="container">
          ...
          <div className="row g-4 mt-4">
            {data.why_uk.reasons.map((reason: string, i: number) => (
        ...
        <div className="container">
          ...
          <div className="row g-4 mt-5">
            ...
            <div className="col-lg-4">
              <div className="modern-card p-4 h-100" dir={isRTL ? "rtl" : "ltr"}>
                <div className="d-flex align-items-center mb-3">
                  <i className="fas fa-file-invoice text-study-primary fs-2 me-3"></i>
                  <h4 className="mb-0">{data.costs.fees.title}</h4>
                </div>
                <ul className="list-unstyled">
                  {data.costs.fees.details.map((detail: string, i: number) => (
                    <li key={i} className="mb-2">
                      <i className="fas fa-check-circle text-study-secondary me-2"></i>
                      {detail}
                    </li>
