      ...
      <section className="section-modern soft-bg">
        <div className="container">
          <h2 className="section-title" dir={isRTL ? "rtl" : "ltr"}>
            {data.why_germany.heading}
          </h2>
          
          <div className="row g-4 mt-4">
            {data.why_germany.reasons.map((reason: string, i: number) => (
        ...
        <div className="container">
          ...
          <div className="row g-4 mt-5">
            ...
            <div className="col-lg-4">
              <div className="modern-card p-4 h-100" dir={isRTL ? "rtl" : "ltr"}>
                <div className="d-flex align-items-center mb-3">
                  <i className="fas fa-piggy-bank text-study-primary fs-2 me-3"></i>
                  <h4 className="mb-0">{data.costs.blocked_account.title}</h4>
                </div>
                <ul className="list-unstyled">
                  {data.costs.blocked_account.details.map((detail: string, i: number) => (
                    <li key={i} className="mb-2">
                      <i className="fas fa-check-circle text-study-secondary me-2"></i>
                      {detail}
                    </li>
